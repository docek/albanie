...
ROUTES = {
 'D': {'color': '#24567f', 'days': [
   ...
   ('Po', 'Zkouška 2: Përmet → Frashër → Ersekë → Korçë', [('Bënja / Lengarica','Përmet','car'),('Përmet','Frashër','track'),('Frashër','Ersekë','track'),('Ersekë','Korçë','car')], 'Korçë'),
   ('Út', 'Voskopojë → Vithkuq → Osumi → Çorovodë', [('Korçë','Voskopojë','car'),('Voskopojë','Vithkuq','car'),('Vithkuq','Çorovodë','track')], 'Çorovodë'),
