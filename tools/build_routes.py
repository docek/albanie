...
W = {
    ...
    'Çorovodë': (40.5036, 20.2283), 'Kaňon Osumi': (40.4334, 20.2710), 'Bual': (40.2600, 20.3000),
...
ROUTES = {
 'D': {'color': '#24567f', 'days': [
   ...
   ('Ne', 'Kaňon Osumi → Përmet', [('Çorovodë','Kaňon Osumi','track'),('Kaňon Osumi','Bual','track'),('Bual','Përmet','car'),('Përmet','Bënja / Lengarica','car')], 'Përmet'),
