...
W = {
    ...
    'Çorovodë': (40.5036, 20.2283), 'Kaňon Osumi': (40.4334, 20.2710), 'Frashër': (40.3661, 20.4282),
...
ROUTES = {
 'D': {'color': '#24567f', 'days': [
   ('Pá', 'Letiště → Berat → Roshnik', [('Letiště Tirana','Lushnjë','car'),('Lushnjë','Berat','car'),('Berat','Roshnik','car')], 'Roshnik'),
   ('So', 'Tomorr → Çorovodë', [('Roshnik','Poliçan','car'),('Poliçan','Qafa e Kulmakut','car'),('Qafa e Kulmakut','Tomorr – türbe','track'),('Tomorr – türbe','Qafa e Kulmakut','track'),('Qafa e Kulmakut','Poliçan','car'),('Poliçan','Bogovë','car'),('Bogovë','Çorovodë','car')], 'Çorovodë'),
   ('Ne', 'Osum → Frashër → Përmet', [('Çorovodë','Kaňon Osumi','car'),('Kaňon Osumi','Çorovodë','car'),('Çorovodë','Frashër','track'),('Frashër','Përmet','track'),('Përmet','Bënja / Lengarica','car')], 'Përmet'),
   ('Po', 'Lengarica → Zagoria → Gjirokastër', [('Bënja / Lengarica','Përmet','car'),('Përmet','Këlcyrë','car'),('Këlcyrë','Gjirokastër','car'),('Gjirokastër','Libohovë','car'),('Libohovë','Selckë','track'),('Selckë','Poliçan (Zagoria)','track'),('Poliçan (Zagoria)','Sheper','track'),('Sheper','Ndëran','track'),('Ndëran','Fushë Çajupi','track'),('Fushë Çajupi','Gjirokastër','car')], 'Gjirokastër'),
   ('Út', 'Gjirokastër → Tepelenë → Nivicë', [('Gjirokastër','Tepelenë','car'),('Tepelenë','Progonat','track'),('Progonat','Nivicë','track')], 'Nivicë'),
   ('St', 'Nivicë → Apollonia → Tirana', [('Nivicë','Progonat','track'),('Progonat','Tepelenë','track'),('Tepelenë','Fier','car'),('Fier','Apollonia','car'),('Apollonia','Tirana','car')], 'Tirana'),
   ('Čt', 'Bovilla → letiště', [('Tirana','Bovilla','track'),('Bovilla','Letiště Tirana','car')], None),
 ]},
 'B': {'color': '#b5461f', 'days': [
   ...
   ('Ne', 'Osum → Frashër → Përmet', [('Çorovodë','Kaňon Osumi','car'),('Kaňon Osumi','Çorovodë','car'),('Çorovodë','Frashër','track'),('Frashër','Përmet','track'),('Përmet','Bënja / Lengarica','car')], 'Përmet'),
   ('Po', 'Lengarica → SH75 → Korçë', [('Bënja / Lengarica','Përmet','car'),('Përmet','Leskovik','car'),('Leskovik','Barmash','car'),('Barmash','Ersekë','car'),('Ersekë','Korçë','car')], 'Korçë'),
   ('Út', 'Voskopojë → Vithkuq → hřebenovka → Berat', [('Korçë','Voskopojë','car'),('Voskopojë','Vithkuq','car'),('Vithkuq','Berat','track')], 'Berat'),
...
def main():
    ...
    for rk, r in ROUTES.items():
        ...
        fn = {'D': 'Doporucena-trasa-D.gpx', 'B': 'Alternativa-B.gpx'}[rk]
