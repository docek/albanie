...
ROUTES = {
 'D': {'color': '#24567f', 'days': [
   ...
   ('Po', 'Përmet → okruh Zagoria → Gjirokastër', [('Bënja / Lengarica','Përmet','car'),('Përmet','Këlcyrë','car'),('Këlcyrë','Gjirokastër','car'),('Gjirokastër','Libohovë','car'),('Libohovë','Selckë','track'),('Selckë','Poliçan (Zagoria)','track'),('Poliçan (Zagoria)','Sheper','track'),('Sheper','Ndëran','track'),('Ndëran','Fushë Çajupi','track'),('Fushë Çajupi','Gjirokastër','car')], 'Gjirokastër'),
   ('Út', 'Gjirokastër → Peshtura → Nivicë', [('Gjirokastër','Tepelenë','car'),('Tepelenë','Progonat','track'),('Progonat','Nivicë','track')], 'Nivicë'),
   ('St', 'Kaňon Nivica → Apollonia → Tirana', [('Nivicë','Progonat','track'),('Progonat','Tepelenë','track'),('Tepelenë','Fier','car'),('Fier','Apollonia','car'),('Apollonia','Tirana','car')], 'Tirana'),
